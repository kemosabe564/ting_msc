...
def in_domain(point):
    if (point[0] > domain[0][0] and point[0] < domain[2][0] and point[1] > domain[0][1] and point[1] < domain[2][1]):
        return True
    else:
        False
...
class ObstacleAvoidance:
    ...
    def check_in_domain(self, point):
        if (point[0] > domain[0][0] and point[0] < domain[2][0] and point[1] > domain[0][1] and point[1] < domain[1][1]):
            if obstacles:
                print("fix dit")
            else:
                return True
